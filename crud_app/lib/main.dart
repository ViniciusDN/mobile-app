...
import 'package:crud_app/views/produto_form.dart';
import 'package:crud_app/views/produto_list.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
        ...
        ChangeNotifierProvider(create: (ctx) => ProdutoProvider()), // Adicione o provider de produtos
      ],
      child: MaterialApp(
          title: 'Flutter Demo',
          theme: ThemeData(
          ...
          routes: {
          Routes.INICIAL: (_) => HomeScreen(),
          Routes.FORMULARIO_CLIENTE: (_) => Formulaire(),
          Routes.FORMULARIO_PRODUTO: (_) => FormularioProduto(),
          Routes.CLIENTES: (_) => ClientsList(), // Adicione esta linha para a rota /clientes
